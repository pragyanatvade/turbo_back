...
var len__4736__auto___54009 = arguments.length;
var i__4737__auto___54010 = (0);
while(true){
if((i__4737__auto___54010 < len__4736__auto___54009)){
args__4742__auto__.push((arguments[i__4737__auto___54010]));

var G__54011 = (i__4737__auto___54010 + (1));
i__4737__auto___54010 = G__54011;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq53981){
var G__53982 = cljs.core.first(seq53981);
var seq53981__$1 = cljs.core.next(seq53981);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53982,seq53981__$1);
}));
...
return cljs.core.some((function (p1__53986_SHARP_){
return (p1__53986_SHARP_ === object);
}),history);
});
