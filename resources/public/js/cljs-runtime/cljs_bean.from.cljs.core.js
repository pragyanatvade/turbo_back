...
var G__53634 = cljs.core.next(xs);
var G__53635 = cljs.core.next(ys);
xs = G__53634;
ys = G__53635;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__53492 = val;
var G__53493 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__53492,G__53493) : f.call(null,G__53492,G__53493));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__53498 = val__$1;
var G__53499 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__53498,G__53499) : f.call(null,G__53498,G__53499));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__53503 = val__$1;
var G__53504 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__53503,G__53504) : f.call(null,G__53503,G__53504));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__53682 = cljs.core.next(es);
var G__53683 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__53682;
tcoll__$1 = G__53683;
continue;
} else {
...
var G__53690 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__53691 = cljs.core.next(es);
ret = G__53690;
es = G__53691;
continue;
} else {
