...
var G__54218 = devtools.prefs.pref(v);
v = G__54218;
continue;
} else {
return v;
...
}catch (e54181){var _e__53642__auto__ = e54181;
return false;
}})();
...
}catch (e54186){var _e__53642__auto__ = e54186;
return false;
}})();
...
}catch (e54188){var _e__53642__auto__ = e54188;
return false;
}}
}
});
...
var vec__54200 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54200,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54200,(1),null);
...
return cljs.core.some((function (p1__54205_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__54205_SHARP_);
}),template);
});
