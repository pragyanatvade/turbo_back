...
var i_58876 = (0);
while(true){
if((i_58876 < arr.length)){
(arr[i_58876] = null);

var G__58877 = (i_58876 + (1));
i_58876 = G__58877;
continue;
} else {
}
...
var i_58905 = (self__.level + (1));
while(true){
if((i_58905 <= (new_level + (1)))){
(update[i_58905] = self__.header);

var G__58906 = (i_58905 + (1));
i_58905 = G__58906;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_58909 = (update[i]).forward;
(x__$2.forward[i] = (links_58909[i]));
...
var i_58915 = (0);
while(true){
if((i_58915 <= self__.level)){
var links_58916 = (update[i_58915]).forward;
if((x__$1 === (((i_58915 < links_58916.length))?(links_58916[i_58915]):null))){
(links_58916[i_58915] = (x__$1.forward[i_58915]));

var G__58922 = (i_58915 + (1));
i_58915 = G__58922;
continue;
} else {
var G__58923 = (i_58915 + (1));
i_58915 = G__58923;
continue;
}
} else {
...
var G__58940 = nx;
var G__58941 = (level__$1 - (1));
x = G__58940;
level__$1 = G__58941;
continue;
} else {
var G__58942 = x;
var G__58943 = (level__$1 - (1));
x = G__58942;
level__$1 = G__58943;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__58955 = nx;
var G__58956 = (level__$1 - (1));
x = G__58955;
level__$1 = G__58956;
continue;
} else {
var G__58957 = x;
var G__58958 = (level__$1 - (1));
x = G__58957;
level__$1 = G__58958;
continue;
}
