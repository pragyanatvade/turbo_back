...
var G__56544 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__56544;
continue;
} else {
return ch;
...
var vec__56533 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56533,(0),null);
return (match === s);
});
...
var len__4736__auto___56559 = arguments.length;
var i__4737__auto___56560 = (0);
while(true){
if((i__4737__auto___56560 < len__4736__auto___56559)){
args__4742__auto__.push((arguments[i__4737__auto___56560]));

var G__56561 = (i__4737__auto___56560 + (1));
i__4737__auto___56560 = G__56561;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq56539){
var G__56540 = cljs.core.first(seq56539);
var seq56539__$1 = cljs.core.next(seq56539);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56540,seq56539__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__56566__delegate = function (rdr,_){
...
var G__56566 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__56567__i = 0, G__56567__a = new Array(arguments.length -  1);
while (G__56567__i < G__56567__a.length) {G__56567__a[G__56567__i] = arguments[G__56567__i + 1]; ++G__56567__i;}
  _ = new cljs.core.IndexedSeq(G__56567__a,0,null);
} 
return G__56566__delegate.call(this,rdr,_);};
G__56566.cljs$lang$maxFixedArity = 1;
G__56566.cljs$lang$applyTo = (function (arglist__56568){
var rdr = cljs.core.first(arglist__56568);
var _ = cljs.core.rest(arglist__56568);
return G__56566__delegate(rdr,_);
});
G__56566.cljs$core$IFn$_invoke$arity$variadic = G__56566__delegate;
return G__56566;
})()
;
});
