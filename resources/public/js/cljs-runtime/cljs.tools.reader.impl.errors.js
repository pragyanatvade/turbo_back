...
var len__4736__auto___56514 = arguments.length;
var i__4737__auto___56515 = (0);
while(true){
if((i__4737__auto___56515 < len__4736__auto___56514)){
args__4742__auto__.push((arguments[i__4737__auto___56515]));

var G__56516 = (i__4737__auto___56515 + (1));
i__4737__auto___56515 = G__56516;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq56380){
var G__56381 = cljs.core.first(seq56380);
var seq56380__$1 = cljs.core.next(seq56380);
var G__56382 = cljs.core.first(seq56380__$1);
var seq56380__$2 = cljs.core.next(seq56380__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56381,G__56382,seq56380__$2);
}));
...
var G__56522 = (i__4737__auto___56520 + (1));
i__4737__auto___56520 = G__56522;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq56397){
var G__56398 = cljs.core.first(seq56397);
var seq56397__$1 = cljs.core.next(seq56397);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56398,seq56397__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___56523 = arguments.length;
var i__4737__auto___56524 = (0);
while(true){
if((i__4737__auto___56524 < len__4736__auto___56523)){
args__4742__auto__.push((arguments[i__4737__auto___56524]));

var G__56525 = (i__4737__auto___56524 + (1));
i__4737__auto___56524 = G__56525;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq56411){
var G__56412 = cljs.core.first(seq56411);
var seq56411__$1 = cljs.core.next(seq56411);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56412,seq56411__$1);
}));
...
while(true){
if((i__4737__auto___56527 < len__4736__auto___56526)){
args__4742__auto__.push((arguments[i__4737__auto___56527]));

var G__56528 = (i__4737__auto___56527 + (1));
i__4737__auto___56527 = G__56528;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq56418){
var G__56419 = cljs.core.first(seq56418);
var seq56418__$1 = cljs.core.next(seq56418);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56419,seq56418__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___56530 = arguments.length;
var i__4737__auto___56531 = (0);
while(true){
if((i__4737__auto___56531 < len__4736__auto___56530)){
args__4742__auto__.push((arguments[i__4737__auto___56531]));

var G__56532 = (i__4737__auto___56531 + (1));
i__4737__auto___56531 = G__56532;
continue;
} else {
}
break;
...
var init = (function (){var G__56441 = kind;
var G__56441__$1 = (((G__56441 instanceof cljs.core.Keyword))?G__56441.fqn:null);
switch (G__56441__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56441__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq56433){
var G__56434 = cljs.core.first(seq56433);
var seq56433__$1 = cljs.core.next(seq56433);
var G__56435 = cljs.core.first(seq56433__$1);
var seq56433__$2 = cljs.core.next(seq56433__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56434,G__56435,seq56433__$2);
}));
...
var iter__4529__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__56504(s__56505){
return (new cljs.core.LazySeq(null,(function (){
var s__56505__$1 = s__56505;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56505__$1);
if(temp__5735__auto__){
var s__56505__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56505__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__56505__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__56507 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__56506 = (0);
while(true){
if((i__56506 < size__4528__auto__)){
var vec__56508 = cljs.core._nth(c__4527__auto__,i__56506);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56508,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56508,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__56507,id);

var G__56541 = (i__56506 + (1));
i__56506 = G__56541;
continue;
} else {
var G__56542 = (i__56506 + (1));
i__56506 = G__56542;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56507),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__56504(cljs.core.chunk_rest(s__56505__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56507),null);
}
} else {
var vec__56511 = cljs.core.first(s__56505__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56511,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56511,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__56504(cljs.core.rest(s__56505__$2)));
} else {
var G__56543 = cljs.core.rest(s__56505__$2);
s__56505__$1 = G__56543;
continue;
}
}
} else {
