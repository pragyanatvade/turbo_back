...
var o53924 = temp__5733__auto__;
var temp__5733__auto____$1 = (o53924["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o53925 = temp__5733__auto____$1;
return (o53925["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__53633__auto__ = f;
return (o__53633__auto__["toString"]).call(o__53633__auto__);
} else {
return "";
}
}catch (e53928){var _ = e53928;
return "";
}});
...
try{var o__53633__auto___54165 = t;
(o__53633__auto___54165["cljs$lang$ctorPrWriter"]).call(o__53633__auto___54165,t,writer);
}catch (e53940){var __54166 = e53940;
}
...
var char_code = (function (){var o__53633__auto__ = (new String(char$));
return (o__53633__auto__["charCodeAt"]).call(o__53633__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__53633__auto__ = String;
return (o__53633__auto__["fromCharCode"]).call(o__53633__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__53954 = num_code;
switch (G__53954) {
case (1):
return (185);
...
var o__53633__auto__ = String;
return (o__53633__auto__["fromCharCode"]).call(o__53633__auto__,superscript_code);
});
/**
...
}catch (e53969){var _e__53642__auto__ = e53969;
return false;
}})())){
...
var vec__53971 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53971,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o53988 = temp__5733__auto__;
var temp__5733__auto____$1 = (o53988["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o53989 = temp__5733__auto____$1;
return (o53989["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__54000){
var vec__54001 = p__54000;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54001,(0),null);
...
var G__54198 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__54199 = cljs.core.butlast(remaining_tokens);
name_tokens = G__54198;
remaining_tokens = G__54199;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq53997){
var G__53998 = cljs.core.first(seq53997);
var seq53997__$1 = cljs.core.next(seq53997);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53998,seq53997__$1);
}));
...
var vec__54015 = cljs.core.split_with((function (p1__54014_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__54014_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54015,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54015,(1),null);
...
var vec__54022 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54022,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54022,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__54206 = cljs.core.rest(remaining_tokens);
var G__54207 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__54206;
name_tokens = G__54207;
continue;
} else {
...
var vec__54029 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54029,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54029,(1),null);
var vec__54032 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54032,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54032,(1),null);
var vec__54035 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54035,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54035,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54035,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54035,(3),null);
...
var vec__54044 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54044,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54044,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54044,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54044,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54044,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54044,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__54048 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54048,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54048,(1),null);
var vec__54051 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54051,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54051,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__54058 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__54058) : devtools.munging.parse_fn_info_deep.call(null,G__54058));
})()));
}
} else {
return fn_info;
...
var G__54222 = (arity + (1));
var G__54223 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__54071){
var vec__54072 = p__54071;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54072,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54072,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54082_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__54082_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54083_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__54083_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___54228 = arguments.length;
var i__4737__auto___54229 = (0);
while(true){
if((i__4737__auto___54229 < len__4736__auto___54228)){
args__4742__auto__.push((arguments[i__4737__auto___54229]));

var G__54230 = (i__4737__auto___54229 + (1));
i__4737__auto___54229 = G__54230;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__54087){
var vec__54088 = p__54087;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54088,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq54084){
var G__54085 = cljs.core.first(seq54084);
var seq54084__$1 = cljs.core.next(seq54084);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54085,seq54084__$1);
}));
...
var map__54112 = options;
var map__54112__$1 = (((((!((map__54112 == null))))?(((((map__54112.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54112.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54112):map__54112);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54112__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54112__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54112__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54112__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__54113 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54113,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54113,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54113,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54113,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54113,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54113,(5),null);
...
var o__53633__auto__ = f;
return (o__53633__auto__["getBasis"]).call(o__53633__auto__);
});
/**
...
}catch (e54124){var _e__53642__auto__ = e54124;
...
var G__54234 = (obj[cljs.core.first(path)]);
var G__54235 = cljs.core.rest(path);
obj = G__54234;
path = G__54235;
continue;
} else {
...
var _STAR_ = (function (accum,p__54142){
var vec__54143 = p__54142;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54143,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54143,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__54148){
var vec__54149 = p__54148;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54149,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54149,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54149,(2),null);
...
var post_process = (function (p__54156){
var vec__54157 = p__54156;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54157,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54157,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54152_SHARP_){
return (obj[cljs.core.first(p1__54152_SHARP_)]);
}),sorted_matches);
