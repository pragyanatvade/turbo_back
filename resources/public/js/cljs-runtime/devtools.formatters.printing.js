...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq54219){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54220,G__54221,seq54219__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__54232_SHARP_){
return (!((cljs.core.meta(p1__54232_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54236__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e54241){var _e__53642__auto__ = e54241;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e54243){var _e__53642__auto__ = e54243;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__54246 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__54247 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__54247);

try{var map__54248 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54248__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__54246);
}});
...
var temp__5733__auto___54282 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___54282)){
var managed_print_level_54283 = temp__5733__auto___54282;
var _STAR_print_level_STAR__orig_val__54252_54284 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__54253_54285 = managed_print_level_54283;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__54253_54285);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__54250_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__54250_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__54252_54284);
}} else {
job_fn();
}
