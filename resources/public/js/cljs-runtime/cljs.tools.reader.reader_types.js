...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_56368 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_56368(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_56373 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_56373(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56374 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56374(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56375 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56375(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56377 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56377(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56383 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56383(reader);
}
});
...
var G__56449 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__56450 = s.append(c);
c = G__56449;
s = G__56450;
continue;
}
